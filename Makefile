# This Makefile is for the HopSpot extension to perl.
#
...
#     AUTHOR => [q[Nishant Sharma,,,]]
#     BUILD_REQUIRES => { Test::More=>q[0.88], ExtUtils::MakeMaker=>q[6.36] }
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[HopSpot]
#     EXE_FILES => [q[script/hopspot_cgi.pl], q[script/hopspot_create.pl], q[script/hopspot_fastcgi.pl], q[script/hopspot_server.pl], q[script/hopspot_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[HopSpot]
#     NO_META => q[1]
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/hopspot_cgi.pl \
	script/hopspot_create.pl \
	script/hopspot_fastcgi.pl \
	script/hopspot_server.pl \
	script/hopspot_test.pl
MAN3PODS = lib/HopSpot.pm \
	lib/HopSpot/Controller/Auth.pm \
	lib/HopSpot/Controller/Login.pm \
...
PM_TO_BLIB = lib/HopSpot.pm \
	blib/lib/HopSpot.pm \
	lib/HopSpot/Controller/Auth.pm \
	blib/lib/HopSpot/Controller/Auth.pm \
	lib/HopSpot/Controller/Login.pm \
	blib/lib/HopSpot/Controller/Login.pm \
	lib/HopSpot/Controller/Ping.pm \
	blib/lib/HopSpot/Controller/Ping.pm \
	lib/HopSpot/Controller/Portal.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  script/hopspot_cgi.pl $(INST_MAN1DIR)/hopspot_cgi.pl.$(MAN1EXT) \
	  script/hopspot_create.pl $(INST_MAN1DIR)/hopspot_create.pl.$(MAN1EXT) \
	  script/hopspot_fastcgi.pl $(INST_MAN1DIR)/hopspot_fastcgi.pl.$(MAN1EXT) \
	  script/hopspot_server.pl $(INST_MAN1DIR)/hopspot_server.pl.$(MAN1EXT) \
	  script/hopspot_test.pl $(INST_MAN1DIR)/hopspot_test.pl.$(MAN1EXT) 
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/HopSpot.pm $(INST_MAN3DIR)/HopSpot.$(MAN3EXT) \
	  lib/HopSpot/Controller/Auth.pm $(INST_MAN3DIR)/HopSpot::Controller::Auth.$(MAN3EXT) \
	  lib/HopSpot/Controller/Login.pm $(INST_MAN3DIR)/HopSpot::Controller::Login.$(MAN3EXT) \
...
EXE_FILES = script/hopspot_cgi.pl script/hopspot_create.pl script/hopspot_fastcgi.pl script/hopspot_server.pl script/hopspot_test.pl

pure_all :: $(INST_SCRIPT)/hopspot_fastcgi.pl $(INST_SCRIPT)/hopspot_test.pl $(INST_SCRIPT)/hopspot_server.pl $(INST_SCRIPT)/hopspot_create.pl $(INST_SCRIPT)/hopspot_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/hopspot_fastcgi.pl $(INST_SCRIPT)/hopspot_test.pl \
	  $(INST_SCRIPT)/hopspot_server.pl $(INST_SCRIPT)/hopspot_create.pl \
	  $(INST_SCRIPT)/hopspot_cgi.pl 

$(INST_SCRIPT)/hopspot_fastcgi.pl : script/hopspot_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/hopspot_fastcgi.pl
	$(CP) script/hopspot_fastcgi.pl $(INST_SCRIPT)/hopspot_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/hopspot_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/hopspot_fastcgi.pl

$(INST_SCRIPT)/hopspot_test.pl : script/hopspot_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/hopspot_test.pl
	$(CP) script/hopspot_test.pl $(INST_SCRIPT)/hopspot_test.pl
	$(FIXIN) $(INST_SCRIPT)/hopspot_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/hopspot_test.pl

$(INST_SCRIPT)/hopspot_server.pl : script/hopspot_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/hopspot_server.pl
	$(CP) script/hopspot_server.pl $(INST_SCRIPT)/hopspot_server.pl
	$(FIXIN) $(INST_SCRIPT)/hopspot_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/hopspot_server.pl

$(INST_SCRIPT)/hopspot_create.pl : script/hopspot_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/hopspot_create.pl
	$(CP) script/hopspot_create.pl $(INST_SCRIPT)/hopspot_create.pl
	$(FIXIN) $(INST_SCRIPT)/hopspot_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/hopspot_create.pl

$(INST_SCRIPT)/hopspot_cgi.pl : script/hopspot_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/hopspot_cgi.pl
	$(CP) script/hopspot_cgi.pl $(INST_SCRIPT)/hopspot_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/hopspot_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/hopspot_cgi.pl
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Nishant Sharma,,,</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/HopSpot.pm blib/lib/HopSpot.pm \
	  lib/HopSpot/Controller/Auth.pm blib/lib/HopSpot/Controller/Auth.pm \
	  lib/HopSpot/Controller/Login.pm blib/lib/HopSpot/Controller/Login.pm \
